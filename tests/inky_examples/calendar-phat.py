...
draw.rectangle((cal_x, cal_y, cal_x + cal_w - 1, cal_y + cal_h - 1), fill=inky_display.BLACK,
               outline=inky_display.WHITE)
...
img.paste(inky_display.WHITE, (month_year_x, cal_y + 4), month_mask)

# Print the year right below the month
print_number((month_year_x, cal_y + 5 + col_h), now.year, inky_display.WHITE)
